...
struct StoryBrain {
    ...
    let example = [
        Story(
            ...
            c1: "I'll hop in. Thanks for the help!", ch1Des: 2,
            c2: "Better ask him if he's a murderer first.", ch2Des: 1
        ),
        Story(
            t: "He nods slowly, unfazed by the question.",
            c1: "At least he's honest. I'll climb in.", ch1Des: 2,
            c2: "Wait, I know how to change a tire.", ch2Des: 3
        ),
        Story(
            ...
            c1: "I love Elton John! Hand him the cassette tape.", ch1Des: 5,
            c2: "It's him or me! You take the knife and stab him.", ch2Des: 4
        ),
        Story(
    ...
    mutating func checkAnswer(_ userAnswer: String){
        ...
        if userAnswer == example[storyNumber].choice1{
